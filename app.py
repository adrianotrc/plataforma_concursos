...
def processar_refinamento_em_background(user_id, job_id, original_plan, feedback_text):
    ...
    try:
        ...
        prompt = (
            ...
            "1. **ANÁLISE DO PEDIDO:** Primeiro, analise cuidadosamente o que o aluno está pedindo. Se ele mencionar mudanças de tempo de estudo (ex: '2 horas aos domingos', '45 minutos nas terças'), você DEVE reestruturar completamente o plano para acomodar essas mudanças.\n"
            "2. **REESTRUTURAÇÃO INTELIGENTE:** Quando o aluno pedir mudanças de tempo de estudo, você deve:\n"
            "   - Recalcular o tempo total disponível por dia conforme solicitado\n"
            "   - Redistribuir todas as matérias de forma equilibrada na semana\n"
            "   - Considerar a duração das sessões (geralmente 25 minutos) para criar múltiplas atividades quando necessário\n"
            "   - Garantir que todas as matérias do plano original sejam incluídas na nova distribuição\n"
            "3. **DURAÇÃO DAS SESSÕES:** Mantenha a duração das sessões do plano original (ex: 25 minutos). Se o aluno pedir 2 horas de estudo, crie 4-5 atividades de 25 minutos. Se pedir 45 minutos, crie 2 atividades de 25 minutos.\n"
            "4. **DISTRIBUIÇÃO DE MATÉRIAS:** Não duplique matérias no mesmo dia. Distribua as matérias de forma inteligente ao longo da semana, considerando:\n"
            "   - Variedade de métodos de estudo\n"
            "   - Equilíbrio entre matérias\n"
            "   - Tempo disponível em cada dia\n"
            "5. **DIAS SEM ATIVIDADE:** Se o aluno mencionar que não estudará em certos dias, remova as atividades desses dias. Se mencionar que começará a estudar em novos dias, adicione atividades apropriadas.\n"
            "6. **PROCESSO DE EXECUÇÃO:**\n"
            "   - Entenda o pedido do aluno completamente\n"
            "   - Recalcule o tempo disponível por dia\n"
            "   - Redistribua todas as matérias considerando o novo tempo\n"
            "   - Mantenha a estrutura JSON original\n"
            "   - Garanta que todas as matérias do plano original sejam incluídas\n"
            "7. **ATUALIZE O RESUMO:** No campo 'resumo_estrategico', adicione uma nova linha começando com 'Ajuste realizado:', descrevendo as mudanças de tempo e distribuição realizadas.\n"
            "8. **FORMATO DE SAÍDA:** A resposta DEVE ser um único objeto JSON contendo a estrutura completa e atualizada do plano de estudos, com a chave principal 'plano_de_estudos'.\n\n"
            "### EXEMPLO DE APLICAÇÃO:\n"
            "Se o aluno pedir '2 horas aos domingos e 45 minutos nas terças', você deve:\n"
            "1. Definir domingo com 120 minutos (4-5 atividades de 25 min)\n"
            "2. Definir terça com 50 minutos (2 atividades de 25 min)\n"
            "3. Redistribuir todas as matérias considerando esses novos tempos\n"
            "4. Manter o equilíbrio e variedade de métodos de estudo"
        )
