...
// Usa o sistema de modal que já funciona (processing-ui.js)
window.confirmCustom = async (options) => {
    ...
    if (window.processingUI && typeof window.processingUI.showConfirmationModal === 'function') {
        console.log('Usando processingUI para modal');
        
        return new Promise((resolve) => {
            window.processingUI.showConfirmationModal({
                title: options.title || 'Confirmar Ação',
                message: options.message || 'Tem certeza que deseja realizar esta ação?',
